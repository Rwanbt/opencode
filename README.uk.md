...
- `--cache-type-k/v q4_0` — KV-кеш з обертанням Адамара (економія пам'яті 72%)
- `--fit on` — автоматичне підлаштування розміру контексту та розміщення GPU-шарів під доступну VRAM
