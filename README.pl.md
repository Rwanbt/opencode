...
- `--cache-type-k/v q4_0` — Cache KV z rotacją Hadamarda (oszczędność 72% pamięci)
- `--fit on` — automatycznie dostosowuje rozmiar kontekstu i rozmieszczenie warstw GPU do dostępnej VRAM
