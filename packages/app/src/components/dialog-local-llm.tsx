...
const MODEL_CATALOG = [
  { id: "gemma-4-e4b", name: "Gemma 4 E4B", description: "Google's latest expert — 131K context, 140+ languages, best quality locally", size: "5.0 GB", sizeBytes: 4_977_169_088, url: "https://huggingface.co/unsloth/gemma-4-E4B-it-GGUF/resolve/main/gemma-4-E4B-it-Q4_K_M.gguf", filename: "gemma-4-E4B-it-Q4_K_M.gguf", recommended: true },
  { id: "gemma-4-e2b", name: "Gemma 4 E2B", description: "Gemma 4 at half capacity — fits mid-range hardware", size: "3.1 GB", sizeBytes: 3_106_735_776, url: "https://huggingface.co/unsloth/gemma-4-E2B-it-GGUF/resolve/main/gemma-4-E2B-it-Q4_K_M.gguf", filename: "gemma-4-E2B-it-Q4_K_M.gguf" },
  { id: "gemma-3-4b", name: "Gemma 3 4B", description: "Google's previous-gen coding-capable small model", size: "2.5 GB", sizeBytes: 2_500_000_000, url: "https://huggingface.co/unsloth/gemma-3-4b-it-GGUF/resolve/main/gemma-3-4b-it-Q4_K_M.gguf", filename: "gemma-3-4b-it-Q4_K_M.gguf" },
