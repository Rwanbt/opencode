export const dict = {
  ...
  "dialog.debate.description": "Choose at least two annex models. The current model remains the primary synthesizer.",
  "dialog.debate.primary": "Primary: {{model}}",
  ...
  "dialog.debate.minimum": "Select at least two annex models.",
  "dialog.debate.save": "Save",
  "dialog.debate.saved": "Debate configuration saved",
  "dialog.debate.invalid": "Select two distinct connected annex models.",
