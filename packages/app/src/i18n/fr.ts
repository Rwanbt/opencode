export const dict = {
  ...
  "settings.localConfig.speculative": "Décodage speculatif (IA locale)",
  ...
  "settings.localConfig.outputModeDescription": "Le mode automatique s adapte au modele et au contexte disponible. Le mode manuel impose une limite fixe.",
  "settings.localConfig.maxOutputTokens": "Maximum de tokens de sortie",
  "settings.localConfig.maxOutputDescription": "Nombre maximal de tokens generes par reponse",
  "settings.localConfig.contextModeDescription": "Le mode automatique utilise la fenetre native du modele. Le mode manuel permet de la limiter.",
  "settings.localConfig.contextSize": "Taille du contexte",
  "settings.localConfig.contextSizeDescription": "Taille maximale de la fenetre de contexte",
  "settings.localConfig.temperatureDescription": "Plus elevee = plus creatif, plus basse = plus precis (0.0 - 2.0)",
  "settings.localConfig.topPDescription": "Seuil d echantillonnage nucleus (0.0 - 1.0)",
  "settings.localConfig.topKDescription": "Limite aux K tokens les plus probables (1 - 100). Le defaut Gemma/Gallery est 64.",
  ...
  "settings.localConfig.offloadDescription": "Repartition des couches du modele entre GPU et CPU",
  "settings.localConfig.mmap": "Mapping memoire (mmap)",
  "settings.localConfig.mmapDescription": "Utiliser le mapping memoire du systeme pour les poids du modele",
  "settings.localConfig.draftModel": "Modele brouillon",
  "settings.localConfig.draftModelDescription": "Petit modele pour le decodage speculatif (gain de 2 a 3 fois)",
  "settings.localConfig.cpuThreadsDescription": "Nombre de threads CPU pour l inference (0 = detection automatique des coeurs rapides)",
  "settings.localConfig.flashAttentionDescription": "Activer le noyau d attention optimise (recommande)",
  "settings.localConfig.cacheReuseDescription": "Reutiliser le cache KV entre les tours pour accelerer les conversations",
  "settings.localConfig.batchSizeDescription": "Taille des lots de tokens pour le pre-remplissage (plus grand = plus rapide, plus de VRAM)",
  "settings.localConfig.promptPlaceholder": "ex. Vous etes un ingenieur C++ senior. Citez toujours les chemins et numeros de ligne.",
  "settings.fork.audio.title": "Audio",
  "settings.fork.audio.stt": "Reconnaissance vocale (STT)",
  "settings.fork.audio.tts": "Synthese vocale (TTS)",
  "settings.fork.audio.voiceCloning": "Clonage de voix",
  "settings.fork.benchmark.title": "Benchmark",
  "settings.fork.benchmark.description": "Mesurer la vitesse d inference sur cet appareil",
  "settings.fork.benchmark.run": "Executer",
  "settings.fork.benchmark.targetModel": "Modele cible",
  "settings.fork.benchmark.activeBackend": "Moteur actif",
  "settings.fork.benchmark.bestResult": "Meilleur resultat par modele",
  "settings.fork.benchmark.history": "Historique des executions",
  "settings.fork.observability.title": "Observabilite",
  "settings.fork.observability.refresh": "Actualiser",
  "settings.fork.observability.dataScope": "Portee des donnees",
  "settings.fork.observability.capture": "Capture",
  "settings.fork.observability.retention": "Retention",
  "settings.fork.observability.health": "Sante du service",
  "settings.fork.observability.deleteData": "Supprimer les donnees locales d observabilite",
  "settings.fork.observability.sessionEvents": "Evenements de session",
  "settings.fork.observability.compare": "Comparer les configurations",
  "settings.fork.observability.costLast7Days": "Cout — 7 derniers jours",
  "settings.fork.observability.totalCost": "Cout total",
  "settings.fork.observability.totalEvents": "Evenements totaux",
  "settings.fork.observability.failed": "Echecs",
  "settings.fork.observability.aborted": "Abandonnes",
  "settings.fork.observability.costPerTurn": "Cout par tour et configuration",
  ...
  "settings.fork.config.exportDescription": "Telecharger opencode-config.json avec tous vos reglages",
  ...
  "settings.fork.config.importDescription": "Restaurer depuis un fichier opencode-config.json exporte",
  "settings.fork.config.import": "Importer",
  "settings.fork.config.importing": "Import…",
  "settings.fork.config.exportFailed": "Export echoue",
  "settings.fork.config.importFailed": "Import echoue",
  "settings.fork.config.imported": "Configuration importee — rechargement en cours…",
  "settings.fork.android.temperature": "Temperature",
  "settings.fork.android.temperatureDescription": "Etat thermique du processeur / GPU",
  "settings.fork.android.ram": "RAM",
  "settings.fork.android.ramDescription": "Memoire vive utilisee par le systeme",
  ...
  "settings.fork.android.storageRequired": "Necessaire pour acceder aux fichiers du stockage partage",
  ...
  "settings.fork.android.platformDescription": "Version du systeme",
  ...
  "settings.fork.audio.enableTts": "Activer la synthese vocale",
  "settings.fork.audio.enableTtsDescription": "Afficher le bouton haut-parleur sous les reponses IA",
  ...
  "settings.fork.audio.autoPlayDescription": "Lire automatiquement les reponses IA a voix haute",
  "settings.fork.audio.cloneVoice": "Cloner une voix",
  "settings.fork.audio.recording": "Enregistrement…",
  "settings.fork.audio.customVoices": "Voix personnalisees",
  ...
  "settings.fork.observability.notExportable": "Non exportable",
