...
function App() {
  ...
  // (generated by the desktop Settings → Remote Access QR code). Returns true if the
  // link was understood and the form was populated, false otherwise.
  function applyPairingDeepLink(raw: string): boolean {
    ...
    setMode("remote-prompt")
    // Auto-submit — the user already expressed intent by scanning the QR.
