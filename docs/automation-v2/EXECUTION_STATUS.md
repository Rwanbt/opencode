...
> HEAD local : `a1c3de202d` (batches: D-02 V4 matrix -> FC-31B host adapter -> FC-32/FC-04 measured Native+DBOS -> FC-14/FC-25 DBOS real `8afeed2c94`/`a1c3de202d`); remote tracking ref : `173117f637`; avance locale : 35 commits.
...
| M0 comparative qualification | Open (P0 complete) | QUALIFICATION_ONLY | canonical runner `a1c3de202d` gen CURRENT; Native `6 PASS/2 BLOCKED`; DBOS real `6 PASS/2 BLOCKED` - full symmetric P0 matrix measured for both finalists | FC-13 methodology only; then benchmark + ADR-000 rubric |
