...
- `--cache-type-k/v q4_0` — Hadamard rotation KV cache (72% εξοικονόμηση μνήμης)
- `--fit on` — αυτόματη προσαρμογή μεγέθους πλαισίου και τοποθέτησης GPU layers στη διαθέσιμη VRAM
